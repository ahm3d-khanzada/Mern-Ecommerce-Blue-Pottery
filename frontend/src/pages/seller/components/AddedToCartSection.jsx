  ...
  if (responseSpecificProducts) {
    return (
      ...
      >
        ...
        >
          When customers add your products to their cart, they will appear here.
        </Typography>
        <motion.div variants={buttonVariants} whileHover="hover" whileTap="tap">
          <Button
            variant="contained"
    ...
    <MotionBox variants={containerVariants} initial="hidden" animate="visible">
      ...
      >
        <Box sx={{ display: "flex", alignItems: "center" }}>
          <ShoppingCart sx={{ color: "#03c5db", mr: 1, fontSize: "2rem" }} />
          <Typography
            variant="h5"
            component="h1"
            sx={{
                ...
                {filteredProducts.map((product) => (
                  <Grid item xs={12} sm={6} md={4} key={product.productID}>
                    ...
                    >
                      ...
                      <Chip
                        icon={
                          <ShoppingCart sx={{ fontSize: "1rem !important" }} />
                        }
                        ...
                        >
                          ...
                          >
                            <ViewButton
                              onClick={() =>
                                navigate(
                                  "/Seller/orders/product/" + product.productID
                                )
                              }
                              size="small"
                            >
